        ...
        >
          <div className="px-6 py-4 border-b border-zinc-100 flex items-center justify-between bg-zinc-50">
            <h3 className="font-bold text-zinc-900 flex items-center gap-2 text-sm">
              <Plus size={18} className="text-[#00ADC6]" /> {title}
            </h3>
            <button onClick={onClose} className="p-2 hover:bg-zinc-200 rounded-lg transition-colors text-zinc-400 cursor-pointer">
              <Activity size={18} />
            </button>
          </div>
